...
.. image:: https://zenodo.org/badge/DOI/10.5281/zenodo.3688853.svg
   :target: https://doi.org/10.5281/zenodo.3688853
...
Then, installation of `flipchem` can be accomplished using `pip`::
    ...
    pip install git+https://github.com/ilkkavir/flipchem
